# About BarbBlock-filter-list

[![Build Status](https://travis-ci.org/Ultimate-Hosts-Blacklist/BarbBlock-filter-list.svg?branch=master)](https://travis-ci.org/Ultimate-Hosts-Blacklist/BarbBlock-filter-list)
